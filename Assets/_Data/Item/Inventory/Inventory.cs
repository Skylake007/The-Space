...
public class Inventory : SaiMonoBehaviour
{
	...
	protected override void Start()
	{
		...
		//this.AddItem(ItemCode.IronOre, 50);
	}
	...
	protected virtual ItemInventory GetItemNotFullStack(ItemCode itemCode)
	{
		...
		{ //Duyệt tìm item nếu trùng code và ô đó chưa đầy
	...
	//{
	////Tìm trong danh sách Nếu item chưa có trong inventory sẽ tự tạo một item trống và thêm vào danh sách
