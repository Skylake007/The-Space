...
public abstract class Spawner : SaiMonoBehaviour
{
	...
	public virtual Transform Spawn(string prefabName, Vector3 spawnPos, Quaternion rotation)
	{
		...
		//Debug.LogWarning("Refabname" + prefab);
	...
	{
		Transform newRefab = this.GetObjectFromPool(prefab);
		newRefab.SetLocalPositionAndRotation(spawnPos, rotation);

		newRefab.SetParent(this.holder);
		this.spawnedCount++;
